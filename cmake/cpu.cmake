...
if (RXS_64_BIT AND CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|AMD64)$")
...
if (ARM_TARGET AND ARM_TARGET GREATER 6)
    set(RXS_ARM ON)
    add_definitions(-DRXS_ARM=${ARM_TARGET})
...
if (WITH_SSE4_1)
    add_definitions(-DRXS_FEATURE_SSE4_1)
endif()

if (WITH_AVX2)
    add_definitions(-DRXS_FEATURE_AVX2)
endif()
