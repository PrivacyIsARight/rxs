...
option(ENABLE_MARCH_NATIVE "Enable -march=native for native CPU optimizations" ON)
...
if (CMAKE_CXX_COMPILER_ID MATCHES GNU)
    ...
    set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -Ofast -funroll-loops")

    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -fexceptions -fno-rtti -Wno-strict-aliasing -Wno-class-memaccess")
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -Ofast -s -funroll-loops")
...
elseif (CMAKE_CXX_COMPILER_ID MATCHES Clang)
    ...
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -Ofast -funroll-loops")
